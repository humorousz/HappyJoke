 ...
 * 2.为什么要使用抽象类而不是接口？接口只能定义抽象的方法，不可以实现，例如{@link #getAsyn(String , RequestListener)}
...
public abstract class HttpClient {
     ...
     * @param listener
     */
    public abstract void getAsyn(String url,Map<String,String> params,RequestListener listener);
